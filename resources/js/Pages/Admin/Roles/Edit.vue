        ...
        <div class="px-6 py-4 space-y-5 overflow-hidden bg-white shadow-sm sm:rounded-lg">
            ...
            <form @submit.prevent="submit">
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input v-model="form.name" type="text" id="name"
                            ...
                            placeholder="John" :disabled="roleName.toLowerCase() === 'administrator'" required />
                        <div v-if="roleName.toLowerCase() === 'administrator'" class="my-2 text-sm txt-gray-700">Administrator cannot be modified.</div>
                    ...
                    <div>
                        ...
                        <input v-model="form.description" type="text" id="description"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Doe" :disabled="roleName.toLowerCase() === 'administrator'" required />
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <ModalLink :href="route('admin.roles.delete', props.role.id)" :disabled="roleName.toLowerCase() === 'administrator'" @success="modalRef.close" as="button" class="btn-ghost">Delete</ModalLink>
                    </div>

                    <div class="flex items-center gap-x-10">
                        <button @click="modalRef.close" type="button" class="btn-ghost">Cancel</button>
                        <button type="submit" class="btn-primary" :disabled="form.processing || roleName.toLowerCase() === 'administrator'">Save changes</button>
                    </div>
                </div>
